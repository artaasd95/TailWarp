...
*   **Sources:** Classic risk-of-ruin formulas; related to Taleb’s ruin/absorbing-barrier framing in “Statistical Consequences of Fat Tails” (Ch. 23, Lindy as distance from absorbing barrier).
...
*   **Sources:** Taleb Ch. 23 (Lindy as distance from an absorbing barrier) in your docs.
...
*   **Sources:** Standard textbooks; also general discussions on realized volatility proxies.
...
*   **Sources:** κ metric (Taleb 2019) for fat-tailedness / data-sufficiency.
...
*   **Sources:** Parkinson estimator; Garman–Klass; Rogers–Satchell; Yang–Zhang – standard range-based estimators.
...
*   **Sources:** Engle & Zheng’s “A Microstructure Estimate of Realized Volatility”; FX-specific high-frequency risk assessment.
...
*   **Sources:** Microstructure literature on realized vol and noise (Engle & Zheng, etc.).
...
*   **Sources:** Standard QRM/EVT references (e.g., Haugh’s EVT notes); Taleb’s discussion of VaR & CVaR (Ch. 2.2.19) in your docs.
...
*   **Sources:** Standard EVT textbooks – MDA classification and tail diagnostics.
...
*   **Sources:** Hill estimator and tail index estimation literature.
...
*   **Sources:** Taleb “How Much Data Do You Need? An operational, pre-asymptotic metric for fat-tailedness”.
...
*   **Sources:** “On the shadow moments of apparently infinite-mean distributions” (Bree & Taleb); Pareto mean formula $E[X]=L \cdot \alpha/(\alpha-1)$ for $\alpha>1$.
...
*   **Sources:** Gatheral Ch. 5 (Adding Jumps); Jump-diffusion literature in EVT and options pricing.
...
*   **Sources:** Drawdown analysis literature; used in Calmar/Sterling/Ulcer context.
...
*   **Sources:** Peter Martin & Byron McCann; standard references.
...
*   **Sources:** Investopedia and practitioner overviews.
...
*   **Sources:** Sterling ratio overviews.
...
*   **Sources:** Closely related to Ulcer Index and drawdown-based metrics.
...
*   **Sources:** Sortino ratio and downside deviation definitions.
...
*   **Sources:** Keating & Shadwick; Wikipedia and overviews.
...
*   **Sources:** Standard risk / EVT textbooks.
...
*   **Sources:** TailWarp MDA/EVT notes; EVT literature on power-law tails.
...
*   **Sources:** Conceptual extension of EVT-based pricing and tail-index adjustments; Taleb’s “Unique Measure” and options under power laws.
...
*   **Sources:** Risk Management Using Quasi-static Hedging (Allen & Padovani).
...
*   **Sources:** Geanakoplos’ “The Leverage Cycle”.
...
*   **Sources:** Standard risk management; Taleb’s “portfolios should never rely on correlation” (Ch. 29).
...
*   **Sources:** Studies of FX bid–ask spreads and their impact on risk.
...
*   **Sources:** Market impact literature; microstructure models.
...
*   **Sources:** Easley et al. VPIN papers and reviews; Note for FX: Can be implemented using tick-count or quote-imbalance proxies.
...
*   **Sources:** Bangia, Diebold, Schuermann & Stroughair’s LVaR framework; later extensions.
...
*   **Sources:** Morini “Understanding and Managing Model Risk”.
...
*   **Sources:** Knight’s Risk, Uncertainty and Profit; overviews of Knightian uncertainty in economics.
...
*   **Sources:** Behavioral finance and risk-perception literature; mapped to Lens 8 in your docs.
...
*   **Sources:** Microstructure and informed-trading literature (PIN, VPIN).
...
*   **Sources:** FX microstructure / tick-size & HFT behavior studies.
...
*   **Sources:** Sentiment/NLP risk literature (though outside TailWarp’s current geometric focus).
...
*   **Sources:** Taleb Ch. 29 “Portfolios should never rely on correlation”.
...
*   **Sources:** Battiston et al. DebtRank and related network stress frameworks.
...
*   **Sources:** Adrian & Brunnermeier’s CoVaR papers and Fed summaries.
...
*   **Sources:** Contagion and network risk literature (linked to DebtRank and CoVaR).
...
*   **Risk of Ruin / Absorbing Barriers**
    *   Taleb: Lindy as Distance from an Absorbing Barrier (Ch 23) [Link](https://fooledbyrandomness.com/FatTails.html)
...
*   **Rolling Volatility (Close-Close)**
    *   Critique of Volatility Metrics [Link](https://www.fooledbyrandomness.com/jorion.html)
*   **Range-Based Estimators (Parkinson, Garman-Klass, Rogers-Satchell, Yang-Zhang)**
    *   Range-Based Volatility Estimators: Overview [Link](https://portfoliooptimizer.io/blog/range-based-volatility-estimators-overview-and-examples-of-usage)
    *   Properties of range-based volatility estimators (Molnár) [Link](http://mmquant.net/wp-content/uploads/2016/09/range_based_estimators.pdf)
    *   Building a Volatility Targeting Strategy with Range-Based [Link](https://medium.com/@NFS303/building-a-volatility-targeting-strategy-with-range-based-estimators-b905afdd391f)
    *   Forecasting with Range-Based Estimators [Link](https://www.sciencedirect.com/science/article/pii/S1544612323003641)
    *   Six ways to estimate realized volatility [Link](https://macrosynergy.com/research/six-ways-to-estimate-realized-volatility)
*   **Realized Volatility (Microstructure)**
    *   A Microstructure Estimate of Realized Volatility (Engle & Zheng) [Link](https://pages.stern.nyu.edu/rengle/EngleZheng.pdf)
    *   High-Frequency Volatility and Risk in Foreign Exchange (ACM) [Link](https://dl.acm.org/doi/10.1145/3785706.3785734)
*   **Pseudo-Stochastic Volatility**
    *   Taleb: Ch 5.6 (Pseudo-Stochastic Volatility) [Link](https://codowd.com/bigdata/misc/Taleb_Statistical_Consequences_of_Fat_Tails.pdf)
...
*   **Regime Detection (κ, Tail Index)**
    *   Taleb: How Much Data Do You Need? (κ metric) [Link](https://arxiv.org/pdf/1802.05495)

### Lens 3: Downside & Tail Categories

*   **VaR & CVaR (Expected Shortfall)**
    *   Extreme Value Theory for Risk Management [Link](http://www.thierry-roncalli.com/download/HFRM-Chap12.pdf)
    *   Value at Risk, Conditional VaR (Taleb) [Link](https://codowd.com/bigdata/misc/Taleb_Statistical_Consequences_of_Fat_Tails.pdf)
*   **Maximum Domain of Attraction (MDA)**
    *   Extreme Value Theory (Columbia) [Link](http://www.columbia.edu/~mh2078/QRM/EVT_MasterSlides.pdf)
    *   Towards a multivariate Extreme Value Theory [Link](https://www.robots.ox.ac.uk/~davidc/pubs/TechReportSH01.pdf)
*   **Tail Index (α) & Hill Estimator**
    *   Estimation of Tail Index [Link](https://www.iaeng.org/publication/WCE2021/WCE2021_pp19-24.pdf)
    *   Extreme Value Theory and Statistics for Heavy Tail Data [Link](https://repub.eur.nl/pub/12381/ExtremeValueTheory_2003.pdf)
*   **κ Metric (Fat-Tailedness)**
    *   How Much Data Do You Need? (Taleb) [Link](https://ideas.repec.org/a/eee/intfor/v35y2019i2p677-686.html)
    *   Taleb Fat Tails Project (Kappa) [Link](https://www.scribd.com/document/528712118/Paper-Taleb)
*   **Shadow Mean / Shadow Moments**
    *   On the shadow moments of apparently infinite-mean distributions [Link](https://arxiv.org/pdf/1510.06731)
    *   The Fat Tails Statistical Project [Link](https://www.fooledbyrandomness.com/FatTails.html)
    *   Pareto Distribution Mean Formula [Link](https://en.wikipedia.org/wiki/Pareto_distribution)
...
*   **Tail Risk Constraints (Barbell)**
    *   Taleb: Ch 30 (Tail Risk Constraints) [Link](https://codowd.com/bigdata/misc/Taleb_Statistical_Consequences_of_Fat_Tails.pdf)

### Lens 4: Drawdown & "Pain" Categories

*   **Ulcer Index**
    *   Ulcer Index (StockCharts) [Link](https://chartschool.stockcharts.com/table-of-contents/technical-indicators-and-overlays/technical-indicators/ulcer-index)
    *   Understanding the Ulcer Index (Investopedia) [Link](https://www.investopedia.com/terms/u/ulcerindex.asp)
    *   Ulcer Index (Wikipedia) [Link](https://en.wikipedia.org/wiki/Ulcer_index)
*   **Calmar Ratio**
    *   Understanding the Calmar Ratio (Investopedia) [Link](https://www.investopedia.com/terms/c/calmarratio.asp)
    *   Calmar Ratio Overview [Link](https://corporatefinanceinstitute.com/resources/career-map/sell-side/capital-markets/calmar-ratio)
*   **Sterling Ratio**
    *   Sterling Ratio (Wikipedia) [Link](https://en.wikipedia.org/wiki/Sterling_ratio)
    *   Sterling Ratio Explained [Link](https://www.rcmalternatives.com/2014/03/the-sterling-ratio-explained)
*   **Omega Ratio**
    *   Omega Ratio (Wikipedia) [Link](https://en.wikipedia.org/wiki/Omega_ratio)
    *   An Introduction to Omega [Link](https://people.duke.edu/~charvey/Teaching/BA453_2005/Keating_An_introduction_to.pdf)
*   **Sortino Ratio**
    *   Sortino Ratio (Investopedia) [Link](https://www.investopedia.com/terms/s/sortinoratio.asp)
    *   Understanding Downside Deviation [Link](https://www.investopedia.com/terms/d/downside-deviation.asp)

### Lens 5: Asymmetry & Convexity Categories

*   **Convexity Index / Payoff g(x)**
    *   Taleb: X vs. F(X) (Ch 3.10) [Link](https://codowd.com/bigdata/misc/Taleb_Statistical_Consequences_of_Fat_Tails.pdf)
*   **Karamata-Point Pricing**
    *   Relative Pricing Heuristics [Link](https://codowd.com/bigdata/misc/Taleb_Statistical_Consequences_of_Fat_Tails.pdf) (Internal context)

### Lens 6: Exposure & Leverage Categories

*   **Leverage Cycles**
    *   The Leverage Cycle (Geanakoplos) [Link](http://dido.econ.yale.edu/~gean/art/p1304.pdf)
    *   Solving the Present Crisis and Managing the Leverage Cycle (Fed) [Link](https://www.newyorkfed.org/medialibrary/media/research/epr/10v16n1/1008gean.pdf)
    *   Managing the Leverage Cycle (Testimony) [Link](https://financialservices.house.gov/media/file/hearings/111/geanakoplos_-_combined.pdf)

### Lens 7: Liquidity & Market-Structure Categories

*   **Liquidity-Adjusted VaR (LVaR)**
    *   Liquidity-Adjusted Value-at-Risk for Portfolios (Cheung & Dong) [Link](https://summit.sfu.ca/_flysystem/fedora/sfu_migrate/3329/etd2403.pdf)
    *   Portfolio liquidity-adjusted value-at-risk [Link](https://scispace.com/pdf/portfolio-liquidity-adjusted-value-at-risk-4hw32vp890.pdf)
*   **VPIN (Order Flow Toxicity)**
    *   VPIN (QuantResearch) [Link](https://www.quantresearch.org/VPIN.pdf)
    *   Volume-Synchronized Probability of Informed Trading [Link](https://cfr.ivo-welch.info/published/papers/easley-prado-hara.pdf)
    *   Flow Toxicity (Stern NYU) [Link](https://www.stern.nyu.edu/sites/default/files/assets/documents/con_035928.pdf)
*   **FX Spreads & Microstructure**
    *   FX Bid-Ask Spreads (IMF WP) [Link](https://www.imf.org/external/pubs/ft/wp/2005/wp0534.pdf)
    *   Tick Test Accuracy in FX [Link](https://www.efmaefm.org/0efmameetings/efma%20annual%20meetings/2014-Rome/papers/EFMA2014_0302_fullpaper.pdf)

### Lens 8: Behavioral & Decision-Making Risks

*   **Knightian Uncertainty**
    *   Risk versus Uncertainty (Items) [Link](https://items.ssrc.org/privatization-of-risk/risk-versus-uncertainty-frank-knights-brute-facts-of-economic-life/)
    *   Knightian Uncertainty (MIT) [Link](https://news.mit.edu/2010/explained-knightian-0602)
    *   Knightian Uncertainty (Wikipedia) [Link](https://en.wikipedia.org/wiki/Knightian_uncertainty)
*   **Model Risk**
    *   Understanding and Managing Model Risk (Morini) [Link](https://onlinelibrary.wiley.com/doi/book/10.1002/9781118467312)
    *   Understanding and Managing Model Risk (ResearchGate) [Link](https://www.researchgate.net/publication/281766832_Understanding_and_Managing_Model_Risk_A_Practical_Guide_for_Quants_Traders_and_Validators)

### Lens 9: Narrative & Information-Structure Categories

*   **Logic of Risk Taking**
    *   The Logic of Risk Taking (Taleb) [Link](https://medium.com/incerto/the-logic-of-risk-taking-107bf41029d3)

### Lens 10: Cross-Asset & Systemic Categories

*   **Correlation Instability**
    *   Taleb: Portfolios should never rely on correlation [Link](https://codowd.com/bigdata/misc/Taleb_Statistical_Consequences_of_Fat_Tails.pdf)
*   **CoVaR (Systemic Risk)**
    *   CoVaR (Adrian & Brunnermeier - NBER) [Link](https://www.nber.org/system/files/working_papers/w17454/w17454.pdf)
    *   CoVaR (American Economic Review) [Link](https://www.aeaweb.org/articles?id=10.1257/aer.20120555)
    *   CoVaR: A Measure of Systemic Risk (Fed) [Link](https://libertystreeteconomics.newyorkfed.org/2011/04/covar-a-measure-of-systemic-risk)
*   **DebtRank (Network Contagion)**
    *   DebtRank: Too Central to Fail? (Nature) [Link](https://www.nature.com/articles/srep00541)
    *   Stress-test framework based on DebtRank [Link](https://www.ineteconomics.org/uploads/papers/battiston2015leveraging.pdf)
